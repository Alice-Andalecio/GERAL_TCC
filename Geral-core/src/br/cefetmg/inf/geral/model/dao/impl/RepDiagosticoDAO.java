...
public class RepDiagosticoDAO implements IRepDiagnosticoDAO {
    ...
    public Long inserir(RepDiagnostico repdiag) throws PersistenciaException {
        try {
            ...
            pstmt.setString(10, repdiag.getDiagnostico());
            pstmt.setString(11, repdiag.getSexo());
            pstmt.setString(12, repdiag.getNumDias());
            pstmt.setString(13, repdiag.getReprodutor());
            pstmt.setString(14, repdiag.getRaca());
            pstmt.setDate(15, (Date) repdiag.getDataCio());
            pstmt.setTime(16, (Time) repdiag.getHoraCio());
            pstmt.setString(17, repdiag.getCio());
            pstmt.setString(18, repdiag.getMuco());
            pstmt.setString(19, repdiag.getTe());
            pstmt.setString(20, repdiag.getUtero());
            pstmt.setString(21, repdiag.getOvD());
            pstmt.setString(22, repdiag.getOvE());
            pstmt.setString(23, repdiag.getBase());
