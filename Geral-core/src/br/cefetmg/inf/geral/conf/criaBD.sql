...
COPY embriao (seq_embriao, cod_email, nro_embriao, idt_tipo, raca_pura, raca_mestica_1, raca_mestica_2, porcentagem_1, porcentagem_2, nome_pai, nome_mae) FROM stdin;
...
COPY medicamento (cod_medicamento, des_medicamento, nom_medicamento) FROM stdin;
...
COPY rep_parto ("seq_ReproducaoParto", "nro_Animal", "nom_Animal", padrao, doadora, receptora, descarte, "perParto1", "perParto2", "diasGest", tipo, retencao, "dataParto", "horaParto", "tipoParto", grau, "numCrias", "numCria1", pelagem1, peso1, sexo1, "numCria2", pelagem2, peso2, sexo2) FROM stdin;
