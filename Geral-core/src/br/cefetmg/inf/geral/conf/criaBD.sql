...
--
-- Name: embriao embriao_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: embriao relationship51; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: embriao relationship52; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
CREATE TABLE embriao (
    ...
    nome_mae character(30),
    entrada date,
    "tipoEmbriao" text NOT NULL,
    "classificacaoEmbriao" text NOT NULL
);
...
--
-- Name: semen semen_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: semen relationship53; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
