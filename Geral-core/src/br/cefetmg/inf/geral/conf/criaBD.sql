...
--
-- Name: seq_embriao; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE seq_embriao
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE seq_embriao OWNER TO postgres;

--
-- Name: embriao; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE embriao (
    seq_embriao integer DEFAULT nextval('seq_embriao'::regclass) NOT NULL,
    cod_email character(50) NOT NULL,
    nro_embriao character(5) NOT NULL,
    idt_tipo character(1),
    raca_pura character(30),
    raca_mestica_1 character(30),
    raca_mestica_2 character(30),
...
ALTER TABLE public.embriao ADD COLUMN entrada date;
ALTER TABLE public.embriao ADD COLUMN tipo_embriao text;
ALTER TABLE public.embriao ADD COLUMN classificacao_embriao text;
ALTER TABLE public.embriao ADD COLUMN num_pai integer;
ALTER TABLE public.embriao ADD COLUMN num_mae integer;
ALTER TABLE embriao OWNER TO postgres;
...
--
-- Name: rep_diagnostico; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE rep_diagnostico (
    "seq_ReproducaoDiagnostico" integer,
    "numAnimal" integer,
    "nomAnimal" character(50),
    "inseminadasCobertas" character(1),
    vazias character(1),
    gestante character(1),
    "emCrescimento" character(1),
    padrao character(1),
    doadora character(1),
    receptora character(1),
    descarte character(1),
    "dataDiagnostico" date,
    "horaDiagnostico" time with time zone,
    diagnostico character(1),
    sexo character(1),
    "numDias" character(1),
    reprodutor character(1),
    raca character(1),
    "dataCio" date,
    "horaCio" time with time zone,
    cio character(1),
    muco character(1),
    te character(1),
    utero character(1),
...
ALTER TABLE rep_diagnostico OWNER TO postgres;

--
-- Name: rep_inseminacao; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE rep_inseminacao (
    "seq_RepInseminacao" integer,
    "numAnimal" integer,
    "nomAnimal" character(50),
    "inseminadasCobertas" character(1),
    vazias character(1),
    gestantes character(1),
    inseminacao character(1),
    cobricao character(1),
    "somSetor" character(10),
    todos character(1),
    padrao character(1),
    doadora character(1),
    receptora character(1),
    ...
    "horaInseminacao" time with time zone,
    reprodutor character(10),
    raca character(10),
    inseminador character(10),
    "numDoses" character(10),
    "dataCio" date,
    "horaCio" time with time zone,
    cio integer,
    muco integer,
...
ALTER TABLE rep_inseminacao OWNER TO postgres;
...
--
-- Name: seq_semen; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE seq_semen
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE seq_semen OWNER TO postgres;
...
CREATE TABLE semen (
    seq_semen integer DEFAULT nextval('seq_semen'::regclass) NOT NULL,
    cod_email character(50) NOT NULL,
    nro_semen character(5) NOT NULL,
    raca_pura character(30),
    raca_mestica_1 character(30),
    raca_mestica_2 character(30),
    porcentagem_1 integer,
...
ALTER TABLE semen OWNER TO postgres;
...
--
-- Data for Name: embriao; Type: TABLE DATA; Schema: public; Owner: postgres
--
...
--
-- Data for Name: rep_diagnostico; Type: TABLE DATA; Schema: public; Owner: postgres
--
...
--
-- Data for Name: rep_inseminacao; Type: TABLE DATA; Schema: public; Owner: postgres
--
...
--
-- Name: seq_embriao; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('seq_embriao', 1, false);
...
--
-- Name: seq_semen; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('seq_semen', 1, false);
...
--
-- Name: embriao_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY embriao
    ADD CONSTRAINT embriao_pkey PRIMARY KEY (seq_embriao, cod_email);
...
--
-- Name: semen_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY semen
    ADD CONSTRAINT semen_pkey PRIMARY KEY (seq_semen, cod_email);
...
--
-- Name: ix_relationship51; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX ix_relationship51 ON embriao USING btree (cod_email);


--
-- Name: ix_relationship53; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX ix_relationship53 ON semen USING btree (cod_email);
...
--
-- Name: relationship51; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY embriao
    ADD CONSTRAINT relationship51 FOREIGN KEY (cod_email) REFERENCES usuario(cod_email) ON UPDATE RESTRICT ON DELETE RESTRICT;


--
-- Name: relationship52; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY embriao
    ADD CONSTRAINT relationship52 FOREIGN KEY (cod_email) REFERENCES usuario(cod_email) ON UPDATE RESTRICT ON DELETE RESTRICT;


--
-- Name: relationship53; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY semen
    ADD CONSTRAINT relationship53 FOREIGN KEY (cod_email) REFERENCES usuario(cod_email) ON UPDATE RESTRICT ON DELETE RESTRICT;
