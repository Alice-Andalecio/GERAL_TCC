window.onload = function () {
    document.querySelector('#adicionarMed').addEventListener('click', function (e) {
        AdicionarMedicamento(e.target.id)
    });
    document.querySelector('#removerMed').addEventListener('click', function (e) {
        ExcluirMedicamento(e.target.id)
    });
}
...
//Função criada para excluir o último medicamento cadastrado.
