...
window.onload = function () {
    document.querySelector('#adicionarLote').addEventListener('click', function (e) {
        AdicionarLote(e.target.id);
    });
    document.querySelector('#removerLote').addEventListener('click', function (e) {
        RemoverLote(e.target.id);
    });
    document.querySelector('#gerarDieta').addEventListener('click', function (e) {
        GerarDieta(e.target.id);
    });
};
...
function AdicionarLote() {
    ...
    document.querySelector('#checkSilagem' + numLote).addEventListener('click', function (e) {
        ExibirSilagem(e.target.id);
    });
    document.querySelector('#checkRacao' + numLote).addEventListener('click', function (e) {
        ExibirRacao(e.target.id);
    });
    document.querySelector('#checkAlgodao' + numLote).addEventListener('click', function (e) {
        ExibirAlgodao(e.target.id);
    });
    document.querySelector('#checkSoja' + numLote).addEventListener('click', function (e) {
        ExibirSoja(e.target.id);
    });
    document.querySelector('#checkPoupa' + numLote).addEventListener('click', function (e) {
        ExibirPoupa(e.target.id);
    });
    document.querySelector('#checkFuba' + numLote).addEventListener('click', function (e) {
        ExibirFuba(e.target.id);
    });
    document.querySelector('#checkBicarbonato' + numLote).addEventListener('click', function (e) {
        ExibirBicarbonato(e.target.id);
    });
    document.querySelector('#checkNucleo' + numLote).addEventListener('click', function (e) {
        ExibirNucleo(e.target.id);
    });
    document.querySelector('#checkOutra' + numLote).addEventListener('click', function (e) {
        ExibirOutra(e.target.id);
    });

    /* CHAMANDO AS FUNÇÕES QUE CALCULAM O TOTAL DE KG DE CADA ALIMENTO QUE COMPÕE A DIETA (MANHÃ + TARDE) */

    document.querySelector('#silagemTotal' + numLote).addEventListener('click', function (e) {
        CalcTotalSilagem(e.target.id);
    });
    document.querySelector('#racaoTotal' + numLote).addEventListener('click', function (e) {
        CalcTotalRacao(e.target.id);
    });
    document.querySelector('#algodaoTotal' + numLote).addEventListener('click', function (e) {
        CalcTotalAlgodao(e.target.id);
    });
    document.querySelector('#sojaTotal' + numLote).addEventListener('click', function (e) {
        CalcTotalSoja(e.target.id);
    });
    document.querySelector('#poupaTotal' + numLote).addEventListener('click', function (e) {
        CalcTotalPoupa(e.target.id);
    });
    document.querySelector('#fubaTotal' + numLote).addEventListener('click', function (e) {
        CalcTotalFuba(e.target.id);
    });
    document.querySelector('#bicarbonatoTotal' + numLote).addEventListener('click', function (e) {
        CalcTotalBicarbonato(e.target.id);
    });
    document.querySelector('#nucleoTotal' + numLote).addEventListener('click', function (e) {
        CalcTotalNucleo(e.target.id);
    });
    document.querySelector('#outraTotal' + numLote).addEventListener('click', function (e) {
        CalcTotalOutra(e.target.id);
    });
}
...
function CalcTotalRacao() {
    var manha = document.querySelector('#racaoManha' + numLote).value;
    var tarde = document.querySelector('#racaoTarde' + numLote).value;
    var total = parseInt(manha) + parseInt(tarde);

    document.querySelector('#racaoTotal' + numLote).setAttribute('value', total);
}

function CalcTotalAlgodao() {
    var manha = document.querySelector('#algodaoManha' + numLote).value;
    var tarde = document.querySelector('#algodaoTarde' + numLote).value;
    var total = parseInt(manha) + parseInt(tarde);

    document.querySelector('#algodaoTotal' + numLote).setAttribute('value', total);
}

function CalcTotalSoja() {
    var manha = document.querySelector('#sojaManha' + numLote).value;
    var tarde = document.querySelector('#sojaTarde' + numLote).value;
    var total = parseInt(manha) + parseInt(tarde);

    document.querySelector('#sojaTotal' + numLote).setAttribute('value', total);
}

function CalcTotalPoupa() {
    var manha = document.querySelector('#poupaManha' + numLote).value;
    var tarde = document.querySelector('#poupaTarde' + numLote).value;
    var total = parseInt(manha) + parseInt(tarde);

    document.querySelector('#poupaTotal' + numLote).setAttribute('value', total);
}

function CalcTotalFuba() {
    var manha = document.querySelector('#fubaManha' + numLote).value;
    var tarde = document.querySelector('#fubaTarde' + numLote).value;
    var total = parseInt(manha) + parseInt(tarde);

    document.querySelector('#fubaTotal' + numLote).setAttribute('value', total);
}
...
function CalcTotalNucleo() {
    var manha = document.querySelector('#nucleoManha' + numLote).value;
    var tarde = document.querySelector('#nucleoTarde' + numLote).value;
    var total = parseInt(manha) + parseInt(tarde);

    document.querySelector('#nucleoTotal' + numLote).setAttribute('value', total);
}

function CalcTotalOutra() {
    var manha = document.querySelector('#outraManha' + numLote).value;
    var tarde = document.querySelector('#outraTarde' + numLote).value;
    var total = parseInt(manha) + parseInt(tarde);

    document.querySelector('#outraTotal' + numLote).setAttribute('value', total);
}
...
//Função criada para validar os dados inseridos pelo usuário e gerar a dieta.

function GerarDieta() {
    var form = document.querySelector('#formDieta');
    var checkSilagem = document.querySelector('#checkSilagem' + numLote);
    var checkRacao = document.querySelector('#checkRacao' + numLote);
    var checkAlgodao = document.querySelector('#checkAlgodao' + numLote);
    var checkSoja = document.querySelector('#checkSoja' + numLote);
    var checkPoupa = document.querySelector('#checkPoupa' + numLote);
    var checkFuba = document.querySelector('#checkFuba' + numLote);
    ...
    var racaoManha = document.querySelector('#racaoManha' + numLote).value;
    var racaoTarde = document.querySelector('#racaoTarde' + numLote).value;
    var racaoTotal = document.querySelector('#racaoTotal' + numLote).value;

    var algodaoManha = document.querySelector('#algodaoManha' + numLote).value;
    var algodaoTarde = document.querySelector('#algodaoTarde' + numLote).value;
    var algodaoTotal = document.querySelector('#algodaoTotal' + numLote).value;

    var sojaManha = document.querySelector('#sojaManha' + numLote).value;
    var sojaTarde = document.querySelector('#sojaTarde' + numLote).value;
    var sojaTotal = document.querySelector('#sojaTotal' + numLote).value;

    var poupaManha = document.querySelector('#poupaManha' + numLote).value;
    var poupaTarde = document.querySelector('#poupaTarde' + numLote).value;
    var poupaTotal = document.querySelector('#poupaTotal' + numLote).value;

    var fubaManha = document.querySelector('#fubaManha' + numLote).value;
    var fubaTarde = document.querySelector('#fubaTarde' + numLote).value;
    var fubaTotal = document.querySelector('#fubaTotal' + numLote).value;

    var bicarbonatoManha = document.querySelector('#bicarbonatoManha' + numLote).value;
    var bicarbonatoTarde = document.querySelector('#bicarbonatoTarde' + numLote).value;
    var bicarbonatoTotal = document.querySelector('#bicarbonatoTotal' + numLote).value;

    var nucleoManha = document.querySelector('#nucleoManha' + numLote).value;
    ...
    if (checkSilagem.checked === true) {
        if (silagemManha === "") {
            alert("Informe a quantidade de silagem (manhã)!");
            document.querySelector('#silagemManha' + numLote).focus();
            return false;
        } else if (silagemTarde === "") {
            alert("Informe a quantidade de silagem (tarde)!");
            document.querySelector('#silagemTarde' + numLote).focus();
            return false;
        } else if (silagemTotal === "") {
            alert("Informe a quantidade de silagem (total)!");
            document.querySelector('#silagemTotal' + numLote).focus();
            return false;
        }
    } else if (checkRacao.checked === true) {
        if (racaoManha === "") {
            alert("Informe a quantidade de ração (manhã)!");
            document.querySelector('#racaoManha' + numLote).focus();
            return false;
        } else if (racaoTarde === "") {
            alert("Informe a quantidade de ração (tarde)!");
            document.querySelector('#racaoTarde' + numLote).focus();
            return false;
        } else if (racaoTotal === "") {
            alert("Informe a quantidade de ração (total)!");
            document.querySelector('#racaoTotal' + numLote).focus();
            return false;
        }
    } else if (checkAlgodao.checked === true) {
        if (algodaoManha === "") {
            alert("Informe a quantidade de algodão (manhã)!");
            document.querySelector('#algodaoManha' + numLote).focus();
            return false;
        } else if (algodaoTarde === "") {
            alert("Informe a quantidade de algodão (tarde)!");
            document.querySelector('#algodaoTarde' + numLote).focus();
            return false;
        } else if (algodaoTotal === "") {
            alert("Informe a quantidade de algodão (total)!");
            document.querySelector('#algodaoTotal' + numLote).focus();
            return false;
        }
    } else if (checkSoja.checked === true) {
        if (sojaManha === "") {
            alert("Informe a quantidade de soja (manhã)!");
            document.querySelector('#sojaManha' + numLote).focus();
            return false;
        } else if (sojaTarde === "") {
            alert("Informe a quantidade de soja (tarde)!");
            document.querySelector('#sojaTarde' + numLote).focus();
            return false;
        } else if (sojaTotal === "") {
            alert("Informe a quantidade de soja (total)!");
            document.querySelector('#sojaTotal' + numLote).focus();
            return false;
        }
    } else if (checkPoupa.checked === true) {
        if (poupaManha === "") {
            alert("Informe a quantidade de poupa cítrica (manhã)!");
            document.querySelector('#poupaManha' + numLote).focus();
            return false;
        } else if (poupaTarde === "") {
            alert("Informe a quantidade de poupa cítrica (tarde)!");
            document.querySelector('#poupaTarde' + numLote).focus();
            return false;
        } else if (poupaTotal === "") {
            alert("Informe a quantidade de poupa cítrica (total)!");
            document.querySelector('#poupaTotal' + numLote).focus();
            return false;
        }
    } else if (checkFuba.checked === true) {
        if (fubaManha === "") {
            alert("Informe a quantidade de fubá (manhã)!");
            document.querySelector('#fubaManha' + numLote).focus();
            return false;
        } else if (fubaTarde === "") {
            alert("Informe a quantidade de fubá (tarde)!");
            document.querySelector('#fubaTarde' + numLote).focus();
            return false;
        } else if (fubaTotal === "") {
            alert("Informe a quantidade de fubá (total)!");
            document.querySelector('#fubaTotal' + numLote).focus();
            return false;
        }
    } else if (checkBicarbonato.checked === true) {
        if (bicarbonatoManha === "") {
            alert("Informe a quantidade de bicarbonato (manhã)!");
            document.querySelector('#bicarbonatoManha' + numLote).focus();
            return false;
        } else if (bicarbonatoTarde === "") {
            alert("Informe a quantidade de bicarbonato (tarde)!");
            document.querySelector('#bicarbonatoTarde' + numLote).focus();
            return false;
        } else if (bicarbonatoTotal === "") {
            alert("Informe a quantidade de bicarbonato (total)!");
            document.querySelector('#bicarbonatoTotal' + numLote).focus();
            return false;
        }
    } else if (checkNucleo.checked === true) {
        if (nucleoManha === "") {
            alert("Informe a quantidade de núcleo vitaminado (manhã)!");
            document.querySelector('#nucleoManha' + numLote).focus();
            return false;
        } else if (nucleoTarde === "") {
            alert("Informe a quantidade de núcleo vitaminado (tarde)!");
            document.querySelector('#nucleoTarde' + numLote).focus();
            return false;
        } else if (nucleoTotal === "") {
            alert("Informe a quantidade de núcleo vitaminado (total)!");
            document.querySelector('#nucleoTotal' + numLote).focus();
            return false;
        }
        ...
        if (outraManha === "") {
            ...
            alert("Informe a quantidade do outro alimento (tarde)!");
            document.querySelector('#outraTarde' + numLote).focus();
            return false;
        } else if (outraTotal === "") {
            alert("Informe a quantidade do outro alimento (total)!");
