...
<body id="top">
  ...
  <section id="process">  
    <br>
    <div class="row">
      <form id="formCadastroAnimal" class="col s12" method="POST">
      ...
      <div class="row">
        ...
        <div class="col s3">
          <select class="browser-default" name="cadSexo" id="cadSexo">
            ...
            <option value="Fêmea">Fêmea</option> <!-- Antes o value era "1" e "2"-->
        ...
        <div class="col s3">
          <select class="browser-default" name="cadPertFaz" id="cadPertFaz">
            ...
            <option value="Sim">Sim</option> <!-- value anterior "1" e "2" -->
      ...
      <div class="row">
        <br><br>
        <div class="col s2">
          <a class="waves-effect waves-light btn" id="salvarCad" onclick="salvarRedirect()" style="background: green">
