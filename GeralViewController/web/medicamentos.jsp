...
<section id="process">  
   <div class="row">
      <center>
         <div class="col s12"> 
            <br><br>        
            <h5><b>Medicamento</b></h5>
         </center>
         <br>
         <div class="row">
            <div class="col s1"></div>
            <div class="input-field col s10 center-block">
               <input id="email" type="email" class="validate">
               <label for="email"><b>Insira o nome do medicamento</b></label>
            </div>
         </div>
         <div class="row">
           <div class="col s1"></div>
      ...
      <div class="row">
         <div class="col s1"></div>
         <div class=" col s10">
            <textarea id="pres" placeholder="Insira a prescrição e observações necessárias"></textarea>
         </div>
      </div>
      <br>
      <div class="row" id="adicionar_excluir-inserir">
         <div class="col s1"></div>
         <div class="col s6">
